...
public class MoreCatchBlocksDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("How many erases do you have?");
			...
			System.out.println("Each eraser must alst through " + pencilsPerEraser + " pencils.");			
		}
		catch(NegativeNumberException e) {
			System.out.println("Can't have a negative number of " + e.getMessage());
		}
